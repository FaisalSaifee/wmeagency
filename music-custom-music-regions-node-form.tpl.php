...
// $default_color_arr = array("#F28258" => "Apricot", "#9D9D5F" => "Avocado", "#1A6EBA" => "Azure", "#1E152A" => "Blackcurrant", "#1C739D" => "Blue", "#E25656" => "Cherry", "#3D8AD0" => "Curious Blue", "#198b19" => "Dark Green", "#660000" => "Dark Red", "#FF007E" => "Deep Pink", "#C13377" => "Fuscia", "#FFC45C" => "Gold", "#73519B" => "Indigo", "#AED4F5" => "Light Blue", "#829AD8" => "Lilac", "#9AA899" => "Mantle", "#D9ACF7" => "Mauve", "#90D591" => "Mint", "#667B7C" => "Nevada", "#666600" => "Olive", "#EA5E82" => "Rose", "#0C5587" => "Royal Blue", "#FFC0EB" => "Pink", "#0FBCBC" => "Teal", "#FFFF9A" => "Yellow", "#FFA500" => "Orange", "#800080" => "Purple", "#00FFFF" => "Cyan789");
...
<div class="add-agent-form">
    <div class="form-content">
        ...
        <div class="agent-details">
         ...
         <div class="tabbed-functionality">
            <div class="form-section-head">
                <div class="form-section-title">Group Emails</div>
                <?php
                    $nid = !empty($form['nid']['#value']) ? $form['nid']['#value'] : 'new';

                    $add_agents_link = '';
                    $add_group_email_link = '';

                    if (!empty($form['nid']['#value'])) {
                        // If the node ID exists, use the existing nid in the links
                        $add_group_email_link = l("Edit Group Email", "Music/add-group-email-to-region/nojs/$nid", array('attributes' => array('class' => 'ctools-use-modal edit-agent-link')));

                        if (empty($node->field_music_agents['und'])) {
                            // If there are no agents, set links to add agents
                            $add_group_email_link = l("Edit Group Email", "Music/add-group-email-to-region/nojs/$nid", array('attributes' => array('class' => 'ctools-use-modal edit-agent-link')));
                        }
                    } else {
                        // If the node ID doesn't exist, use 'new' in the links
                        $add_group_email_link = l("Edit Group Email", "Music/add-group-email-to-region/nojs/new", array('attributes' => array('class' => 'ctools-use-modal edit-agent-link')));
                ...
                <div id="custom_tab_links" class="form-section-actions">
                    <?php print $add_group_email_link; ?>
                </div>
            </div>
            <div class="custom-error red-label group-email hide">Please select an option before proceeding.</div>
            <div class="form-section">
                <?php
                    ...
                    if (!empty($form['nid']['#value'])) {
                        ...
                        print "<div class='group-info'>";
                        print "<div class='group-email'>$group_email</div>";
                        print "</div>";
                    }
                ?>
            </div>
